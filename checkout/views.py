...
import requests
import pyttsx3  # Optional if you want to return audio files later
...
@csrf_exempt
def voicebot_reply(request):
    """Handle voice or text queries sent from frontend."""
    if request.method == "POST":
        ...
        try:
            ...
            data = response.json()
            answer = data.get("choices", [{}])[0].get("message", {}).get("content", "Sorry, no valid response received.")
